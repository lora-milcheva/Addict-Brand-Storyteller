...
const USER_PAGES_TEXT = {
	...
	aboutUs: {
		bg: {
			...
			sections: {
				...
				storyArchetypes: {
					headline: '„Научих, че хората ще забравят какво си казал, хората ще забравят какво си направил, но хората никога няма да забравят как си ги накарал да се почувстват.“',
					text: 'Историята на Addict е история за излизането извън зоната на комфорт и търсенето на необикновени неща.',

					theMonster: {
						title: 'Убий Чудовището или как доброто победи злото.',
						text: 'Съдбата неслучайно ни събра преди 11 години и 6 месеца. На корицата на известно списание видях най-готиния телбод, който съм виждала някога. Да, правилно прочетохте „телбод“. Е, така ни защипа, че от тогава до сега все заедно... реклами, проекти, щуротии, криейтив, абе лудница. За любовта в рекламата няма невъзможни неща.<br/>' +
							'Специални благодарности на Голямата Компания Сдружение Топливо, която ще остане завинаги в сърцата ни. Години, в които  изградихме бранда, години, в които бранда ни отвърна с нужната слава. И после изведнъж, от нищото дойде Чудовището. Чудовището винаги идва когато е време за промяна и носи възможността да опиташ нови неща.<br/' +
							'Така се роди  Addict. Ad Addict.<br/>' +
							'Първата brand storytelling агенция в България.'
					},

					reborn: {
						title: 'Прераждането или когато решиш да отвориш нова страница.',
						text: 'Затварянето на една врата винаги води до отваряне на друга. Лошото е, че това го разбираш чак след като затвориш първата.' +
							'Най-големите компании са изградени от силни истории за преодолени страхове. Ние обичаме да разказваме истории за Големите брандове и преодолените страхове, за брандовете, които имат какво да кажат на света, брандовете, които искат не просто да продават, а да бъдат харесвани от своите клиенти, брандовете, зад които седят Големите Сърца и Умове.\n' +
							'Човешкото в историята за компанията е бъдещето на маркетинга. Защото на хората им писна от тъпи реклами. Защото на хората им писна от недомислени продукти. Защото на хората им писна от „хладнокръвни“ мениджъри, които гонейки финансов просперитет изгонват човешкото от  компанията.'
					},

					ragsToRiches: {
						title: 'От дрипи към богатство, с дъх на пшеница и ръж',
						text: 'Addict започна от нулата. Онази кръглата нула. Не знаеш накъде, но знаеш как, не знаеш, че „storytelling”- а е последният писък на модата в маркетинга в световен мащаб, но знаеш, че точно в това си най-добър, не знаеш колко ще е трудно, но знаеш, че точно ти ще опиташ.' +
							'Johnny Walker е в кръвта ти. Не усещането за уискито, а за Бранда. Брандът, който е пример в световната маркетингова литература за изграждане на история със сюжет „от дрипи към богатство“ и който ще те води по пътя с думите си „Keep Walking”.\n' +
							'Вдъхновяващ е примера на големите. Големите брандове, които с всички свои действия и послания крещят: „Ако не го почувстваш, няма да го запомниш“. И тогава инстинктивно се замисляш... Важно е кой разказва ТВОЯТА История.\n'
					},

					theQuest: {
						title: 'The Quest. Търсенето',
						text: 'Човек среща друг човек в живота си и иска да сподели своята история, за да изгради „връзка“. В света на бизнеса и маркетинга е същото. Компанията изгражда връзка със своя клиент. \n' +
							'„Най-властимащият човек в света е разказвачът. Разказвачът, който задава визията, добавя стойността и определя дневния ред на темите на едно цяло общество.“ казва Стив Джобс, в подкрепа на бранд историите, които е разказал Уолт Дисни, за да изгради точно „тази връзка“.\n' +
							'Addict е първата „brand storytelling” агенция в България. Доста търсихме, но се намерихме. Ние обичаме да разказваме истории.'
					},

					tragedy: {
						title: 'Трагедията или Шекспир в рекламата',
						text: 'От гръцките трагедии през Шекспир до големия Мартин Скорсезе и титанът на филмовата музика Джон Уилямс, разказват брилянтно истории за тъмната страна и уязвимата същност на човека. На сцена. На кино.  В рекламата „трагедията“ като сюжет си остава тема табу. Е, нали все пак някой трябва да го купи този продукт?!'
					},

					comedy: {
						title: 'От другата страна. Комедията: „Art&Joy“ на бранда',
						text: 'Преди много години, един от най-големите режисьори в България, Теофана Преславска, ми каза: „Всичко, което правиш трябва да предизвиква чувство и емоция. Тъга, страх, усмивка, щастие, смях... има ли ги в публиката, постигнала си много!“ \n' +
							'А създаването на комедия... е то просто не е за всеки. Висше изкуство. Трябва ти висока самокритичност, самоирония и приятно чувство за хумор... за да я направиш, и за да я разбереш. \n'
					},

					travel: {
						title: 'Пътешествие и завръщане',
						text: 'Създаването на бранд истории е като пътуване до далечно място. Когато се върнеш, ти вече не си същият. А историята заслужава да бъде разказана!'
					},

					ps: {
						title: 'P.S.',
						text: '7-те cюжета на storytelling-а използвахме съвсем умишлено, за да разкажем илюстративно и лесно своята история и да ви докоснем до нашия свят и ценности.'
					}
				}
			}
		},
	...
	careers: {
		bg: {
			...
			sections: {
				content: {
					headline: 'Мрежа от професионалисти',
					text: '<p>Криейтив директори, писатели, стратези, иноватори, брандинг специалисти, дизайнери, диджитал гурута,<br/>експерти по социални медии, режисьори, оператори, сценаристи, звукари и още...<br/><span class="accent">много готини хора</span> .</p>' +
						'<p>Addict се гордее с добре изградена мрежа от професионалисти, които са „пристрастени“ към работата си.<br/>Обединява ни чувството, че не работим, а обичаме това, което правим.<br/>Сплотява ни общото влечение към самоусъвършенстване и качествено изпълнение на поставените задачи.<br/>Вдъхновява ни креативната амбиция, която ни води към нови върхове и ни кара да правим необикновени неща.<br/>И не на последно място, всички ние изпитваме огромно удоволствие, <br/>когато си свършим работата и видим резултатите, които клиентът постига в бизнеса си.</p>' +
						'<p class="accent-text">Ако споделяш нашите ценности и ти се правят необикновени неща,<br/>ще се радваме да работиш с нас.<br/>Addict търси талантливи фриленсъри, които да се присъединят към екипа ни. </p>',
				},
				callToAction: {
					headline: 'Свържи се с нас.',
					text: '<a href="mailto:office@addict-bg.com" class="accent">office@addict-bg.com</a>'
				}
			}
		},
		en: {
			...
			sections: {
				content: {
					headline: 'A network of professionals',
					text: '<p>Криейтив директори, писатели, стратези, иноватори, брандинг специалисти, дизайнери, диджитал гурута,<br/>експерти по социални медии, режисьори, оператори, сценаристи, звукари и още...<br/><span class="accent">много готини хора</span> .</p>' +
						'<p>Addict се гордее с добре изградена мрежа от професионалисти, които са „пристрастени“ към работата си.<br/>Обединява ни чувството, че не работим, а обичаме това, което правим.<br/>Сплотява ни общото влечение към самоусъвършенстване и качествено изпълнение на поставените задачи.<br/>Вдъхновява ни креативната амбиция, която ни води към нови върхове и ни кара да правим необикновени неща.<br/>И не на последно място, всички ние изпитваме огромно удоволствие, <br/>когато си свършим работата и видим резултатите, които клиентът постига в бизнеса си.</p>' +
						'<p class="accent-text">Ако споделяш нашите ценности и ти се правят необикновени неща,<br/>ще се радваме да работиш с нас.<br/>Addict търси талантливи фриленсъри, които да се присъединят към екипа ни. </p>',
				},
