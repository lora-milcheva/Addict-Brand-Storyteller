				...
				storyArchetypes: {
					...
					ragsToRiches: {
						...
						text: '<p>Addict започна от нулата. Онази кръглата нула.</p>' +
							...
							'<p>Вдъхновяващ е примера на големите. Големите брандове, които с всички свои действия и послания крещят: „Ако не го почувстваш, няма да го запомниш“. И тогава инстинктивно се замисляш... Важно е кой разказва ТВОЯТА История.</p>',
						accent: 'Johnny Walker е в кръвта ти.<br/>Не усещането за уискито, а за Бранда.'
					},

					theQuest: {
						title: '4. The Quest. Търсенето',
						text: '<p>Човек среща друг човек в живота си и иска да сподели своята история, за да изгради „връзка“. В света на бизнеса и маркетинга е същото. Компанията изгражда връзка със своя клиент. „Най-властимащият човек в света е разказвачът. Разказвачът, който задава визията, добавя стойността и определя дневния ред на темите на едно цяло общество.“ казва Стив Джобс, в подкрепа на бранд историите, които е разказал Уолт Дисни, за да изгради точно „тази връзка“. Addict е първата „brand storytelling” агенция в България. Доста търсихме, но се намерихме. Ние обичаме да разказваме истории.</p>',
						accent: ''
					},
					...
					comedy: {
						...
						text: '<p>Преди много години, един от най-големите режисьори в България, Теофана Преславска, ми каза: „Всичко, което правиш трябва да предизвиква чувство и емоция. Тъга, страх, усмивка, щастие, смях... има ли ги в публиката, постигнала си много!“ А създаването на комедия... е то просто не е за всеки. Висше изкуство. Трябва ти висока самокритичност, самоирония и приятно чувство за хумор... за да я направиш, и за да я разбереш.</p>',
		...
		en: {
			...
			sections: {
				...
				storyArchetypes: {
					...
					ragsToRiches: {
						title: '3. От дрипи към богатство, с дъх на пшеница и ръж',
						text: '<p>Addict започна от нулата. Онази кръглата нула. Не знаеш накъде, но знаеш как, не знаеш, че „storytelling”- а е последният писък на модата в маркетинга в световен мащаб, но знаеш, че точно в това си най-добър, не знаеш колко ще е трудно, но знаеш, че точно ти ще опиташ. Johnny Walker е в кръвта ти. Не усещането за уискито, а за Бранда. Брандът, който е пример в световната маркетингова литература за изграждане на история със сюжет „от дрипи към богатство“ и който ще те води по пътя с думите си „Keep Walking”. Вдъхновяващ е примера на големите. Големите брандове, които с всички свои действия и послания крещят: „Ако не го почувстваш, няма да го запомниш“. И тогава инстинктивно се замисляш... Важно е кой разказва ТВОЯТА История.</p>',
						accent: 'Johnny Walker е в кръвта ти.<br/>Не усещането за уискито, а за Бранда.'
					},
