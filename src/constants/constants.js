	...
	home: {
		bg: {
			...
			sections: {
				...
				ourAim: {
					name: 'Нашата цел',
					title: 'Нашата цел е да създаваме и комуникираме бранд истории,<br/> които работят за вашата публика и бизнес.',
				},
				...
				services: {
					name: 'Услуги',
					title: 'Ние помагаме на нашите клиенти да изградят своята Бранд Концепция и да я интегрират успешно в комуникациите си. <br/> <span class="smaller">Важно е, не какво ние казваме на хората, посредством всички сигнали, които брандът ни изпраща, а в какво хората <span class="accent">вярват.</span></span>',
					text: ''
				},
				...
				aboutUs: {
					name: 'За нас',
					title: 'Ние създаваме светове и изграждаме силни образи, които носят собствен дух и характер. <br/>' +
		...
		en: {
			...
			sections: {
				...
				services: {
					name: 'Services',
					title: 'Ние помагаме на нашите клиенти да изградят своята Бранд Концепция и да я интегрират успешно в комуникациите си. <br/> Важно е, не какво ние казваме на хората, посредством всички сигнали, които брандът ни изпраща, а в какво хората вярват.',
					text: ''
				},
				...
				aboutUs: {
					name: 'About us',
					title: 'Разказването на истории е в кръвта ни.',
					text: 'Ние създаваме светове и изграждаме силни образи, които носят собствен дух и характер. Така именно в тях оставяме тази различност, толкова важна, за да бъдат те запомнени и откроени.'
				}
			},
		}
	},
